...
(function () {
    ...
    const observer = new MutationObserver(insertBarcodeIfVisible);
    observer.observe(document.body, { childList: true, subtree: true });

    // Initial insert attempt
    insertBarcodeIfVisible();
})();
